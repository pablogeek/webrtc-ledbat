...
TEST_F(LedbatDataEngineTest, SendDataTwoWays) {
	...
	cricket::SendDataResult result2;
	const std::string msg2 = "chan2 says hello";
	EXPECT_TRUE(chan2()->SendData(params, talk_base::Buffer(msg2.data(), msg2.length()), &result2));
	EXPECT_EQ(cricket::SDR_SUCCESS, result2);
