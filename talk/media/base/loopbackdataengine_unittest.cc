...
class LoopbackDataEngineTest : public testing::Test {
  protected:
	...
	cricket::LoopbackDataMediaChannel* CreateChannel(cricket::FakeNetworkInterface* iface, 
													 FakeDataReceiver* receiver) {
	    cricket::LoopbackDataMediaChannel* channel =
	        static_cast<cricket::LoopbackDataMediaChannel*>(engine_.get()->CreateChannel(
	            cricket::DCT_RTP));
	...
	cricket::LoopbackDataMediaChannel* chan1() { return chan1_.get(); }
	cricket::LoopbackDataMediaChannel* chan2() { return chan2_.get(); }
	FakeDataReceiver* recv1() { return recv1_.get(); }
	FakeDataReceiver* recv2() { return recv2_.get(); }

  private:
  	talk_base::scoped_ptr<cricket::LoopbackDataEngine> engine_;
	...
	talk_base::scoped_ptr<cricket::LoopbackDataMediaChannel> chan1_;
